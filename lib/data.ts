...
- **Email:** fabbricato99@gmail.com
- **Phone:** +91 78170 83122
...
We also provide helpful resources such as order tracking, product guides, and FAQs to assist you with common inquiries. Your satisfaction is our priority, and we’re here to resolve any issues quickly and efficiently. Thank you for choosing us!`,
  ...
  carousels: [
    {
      title: 'Most Popular TShirts For Sale',
  ...
  settings: [
    {
      ...
      site: {
        name: 'Fabbricato',
        description:
          'Fabbricato is a Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
        keywords: 'Next Ecommerce, Next.js, Tailwind CSS, MongoDB',
        url: 'https://next-mongo-ecommerce-final.vercel.app',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'Fabbricato',
        copyright: '2000-2024, fabbricato.com, Inc. or its affiliates',
        email: 'fabbricato88@gmail.com',
        address: 'Miet Incubation, Baghpat Bypass, Meerut, 250001',
        phone: '+91 78170 83122',
      },
      carousels: [
        {
